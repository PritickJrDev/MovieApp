...
public class Movie extends BaseObservable implements Parcelable {
    ...
    public Movie(Parcel in) {
        this.posterPath = ((String) in.readValue((Integer.class.getClassLoader())));
        this.adult = ((Boolean) in.readValue((Integer.class.getClassLoader())));
        this.overview =((String) in.readValue((Integer.class.getClassLoader())));
        this.releaseDate = ((String) in.readValue((Integer.class.getClassLoader())));
      //  in.readList(this.genreIds, (java.lang.Integer.class.getClassLoader()));
        this.id = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.originalTitle = ((String) in.readValue((Integer.class.getClassLoader())));
        this.originalLanguage = ((String) in.readValue((Integer.class.getClassLoader())));
        this.title = ((String) in.readValue((Integer.class.getClassLoader())));
        this.backdropPath = ((String) in.readValue((Integer.class.getClassLoader())));
        this.popularity =((Double) in.readValue((Integer.class.getClassLoader())));
        this.voteCount =((Integer) in.readValue((Integer.class.getClassLoader())));
        this.video = ((Boolean) in.readValue((Integer.class.getClassLoader())));
